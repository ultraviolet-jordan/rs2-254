...
public final class Class43 {
	...
	@OriginalMember(owner = "client!tb", name = "a", descriptor = "I")
	private final int anInt934 = 4096;

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "I")
	private final int anInt935 = 16;

	@OriginalMember(owner = "client!tb", name = "c", descriptor = "I")
	private final int anInt936 = 258;

	@OriginalMember(owner = "client!tb", name = "d", descriptor = "I")
	private final int anInt937 = 23;

	@OriginalMember(owner = "client!tb", name = "e", descriptor = "I")
	private final int anInt938 = 1;

	@OriginalMember(owner = "client!tb", name = "f", descriptor = "I")
	private final int anInt939 = 6;

	@OriginalMember(owner = "client!tb", name = "g", descriptor = "I")
	private final int anInt940 = 50;

	@OriginalMember(owner = "client!tb", name = "h", descriptor = "I")
	private final int anInt941 = 4;

	@OriginalMember(owner = "client!tb", name = "i", descriptor = "I")
	private final int anInt942 = 18002;
	...
	public boolean[] aBooleanArray11 = new boolean[256];

	@OriginalMember(owner = "client!tb", name = "K", descriptor = "[Z")
	public boolean[] aBooleanArray12 = new boolean[16];
