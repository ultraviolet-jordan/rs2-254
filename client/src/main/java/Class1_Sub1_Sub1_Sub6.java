...
public final class Class1_Sub1_Sub1_Sub6 extends Class1_Sub1_Sub1 {
	...
	public Class1_Sub1_Sub1_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		try {
			this.aClass32_2 = Static25.aClass32Array1[arg5];
			this.anInt568 = arg3;
			this.anInt569 = arg4;
			this.anInt570 = arg2;
			this.anInt571 = arg0;
	...
	public void method317(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			while (true) {
				do {
					do {
						if (this.anInt573 <= this.aClass32_2.aClass27_2.method517((byte) -103, this.anInt572)) {
							return;
						}
						this.anInt573 -= this.aClass32_2.aClass27_2.method517((byte) -103, this.anInt572) + 1;
						this.anInt572++;
			...
			signlink.reporterror("65087, " + arg0 + ", " + arg1 + ", " + local73.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Class1_Sub1_Sub1_Sub5 method316(@OriginalArg(0) int arg0) {
		try {
			...
			@Pc(26) Class1_Sub1_Sub1_Sub5 local26 = new Class1_Sub1_Sub1_Sub5(Static13.method328((byte) 8, local15), 992, false, true, local3);
			if (arg0 != 45160) {
				this.aBoolean139 = !this.aBoolean139;
			}
			if (!this.aBoolean140) {
				local26.method295((byte) 112);
				local26.method296(true, local15);
			...
			signlink.reporterror("27363, " + arg0 + ", " + local137.toString());
			throw new RuntimeException();
		}
	}
}
