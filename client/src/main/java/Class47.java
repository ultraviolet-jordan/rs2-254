...
public final class Class47 {
	...
	public int method674() {
		...
		return this.anIntArray265[this.anInt990];
	}
	...
	private void method675() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			this.anInt991 += this.anIntArray266[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray266[local15] = local101 = this.anIntArray266[local22 >> 2 & 0xFF] + this.anInt991 + this.anInt992;
			this.anIntArray265[local15] = this.anInt992 = this.anIntArray266[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
