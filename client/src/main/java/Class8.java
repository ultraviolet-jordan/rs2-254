...
public final class Class8 implements Runnable {
	...
	public void method248(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws IOException {
		try {
			if (!this.aBoolean106) {
				if (this.aBoolean108) {
				...
				synchronized (this) {
					for (@Pc(28) int local28 = 0; local28 < arg3; local28++) {
						this.aByteArray3[this.anInt498] = arg0[local28 + arg1];
			...
			signlink.reporterror("94752, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local90.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method249(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("98587, " + arg0 + ", " + local75.toString());
			throw new RuntimeException();
		}
	}
}
