...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected final void method85(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		try {
			if (arg2 == 7) {
				this.anInt226 = arg0;
				this.anInt227 = arg1;
				this.aFrame_Sub1_2 = new Frame_Sub1(false, this.anInt227, this, this.anInt226);
				this.aGraphics2 = this.method95(0).getGraphics();
				this.aClass37_2 = new Class37(true, this.method95(0), this.anInt226, this.anInt227);
				this.method96(this, 1);
			}
		} catch (@Pc(45) RuntimeException local45) {
			signlink.reporterror("31544, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local45.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(III)V")
	protected final void method86(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			this.anInt226 = arg2;
			this.anInt227 = arg1;
			this.aGraphics2 = this.method95(0).getGraphics();
			...
			signlink.reporterror("57759, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}
	...
	@Override
	public void run() {
		this.method95(0).addMouseListener(this);
		this.method95(0).addMouseMotionListener(this);
		this.method95(0).addKeyListener(this);
		this.method95(0).addFocusListener(this);
	...
	private void method87(@OriginalArg(0) boolean arg0) {
		try {
			...
			signlink.reporterror("61184, " + arg0 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(II)V")
	protected final void method88(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			if (arg0 == 0) {
				this.anInt223 = 1000 / arg1;
			}
		} catch (@Pc(9) RuntimeException local9) {
			signlink.reporterror("19522, " + arg0 + ", " + arg1 + ", " + local9.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		...
		if (Static10.aBoolean127) {
			Static10.method271(local2, (byte) 9, local5, arg0.isMetaDown() ? 1 : 0);
		}
	}
	...
	public final void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt229 = 0;
		if (Static10.aBoolean127) {
			Static10.method272(arg0.isMetaDown() ? 1 : 0, (byte) 2);
		}
	}
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		if (Static10.aBoolean127) {
			Static10.method273(0, local2, local5);
		}
	}
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (Static10.aBoolean127) {
			Static10.method274(local10, 614);
		}
	}
	...
	public final void keyReleased(@OriginalArg(0) KeyEvent arg0) {
		...
		if (Static10.aBoolean127) {
			Static10.method275(-10167, local8);
		}
	}
	...
	protected void method92(@OriginalArg(0) boolean arg0) {
		try {
			...
			signlink.reporterror("68679, " + arg0 + ", " + local11.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method94(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("98703, " + arg0 + ", " + local11.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Component method95(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("34320, " + arg0 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method97(@OriginalArg(0) byte arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		try {
			...
			@Pc(34) FontMetrics local34 = this.method95(0).getFontMetrics(local28);
			@Pc(41) Font local41 = new Font("Helvetica", 0, 13);
			this.method95(0).getFontMetrics(local41);
			if (arg0 == 6) {
				if (this.aBoolean41) {
			...
			signlink.reporterror("36011, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local167.toString());
			throw new RuntimeException();
		}
	}
}
