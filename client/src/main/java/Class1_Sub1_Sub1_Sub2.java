...
public final class Class1_Sub1_Sub1_Sub2 extends Class1_Sub1_Sub1 {
	...
	public Class1_Sub1_Sub1_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		try {
			...
			this.anInt213 = arg5;
			this.anInt214 = arg6;
			this.aClass27_1 = Static23.aClass27Array1[arg8];
			this.anInt215 = 0;
			if (arg4 != 10550) {
				throw new NullPointerException();
			}
			this.anInt216 = Static6.anInt426;
			if (arg7 && this.aClass27_1.anInt810 != -1) {
				this.anInt215 = (int) (Math.random() * (double) this.aClass27_1.anInt809);
				this.anInt216 -= (int) (Math.random() * (double) this.aClass27_1.method517((byte) -103, this.anInt215));
			}
	...
	protected Class1_Sub1_Sub1_Sub5 method316(@OriginalArg(0) int arg0) {
		try {
			...
			if (this.aClass27_1 != null) {
				local9 = Static6.anInt426 - this.anInt216;
				...
				label40: {
					do {
						do {
							if (local9 <= this.aClass27_1.method517((byte) -103, this.anInt215)) {
								break label40;
							}
							local9 -= this.aClass27_1.method517((byte) -103, this.anInt215);
							this.anInt215++;
				...
				this.anInt216 = Static6.anInt426 - local9;
			}
			local9 = -1;
			if (this.aClass27_1 != null) {
				local9 = this.aClass27_1.anIntArray227[this.anInt215];
			}
			@Pc(92) Class9 local92 = Static9.method258(this.anInt208);
			@Pc(108) Class1_Sub1_Sub1_Sub5 local108 = local92.method264(this.anInt209, this.anInt210, this.anInt211, this.anInt212, this.anInt213, this.anInt214, local9);
			if (arg0 != 45160) {
				throw new NullPointerException();
			}
			return local108;
		} catch (@Pc(118) RuntimeException local118) {
			signlink.reporterror("46329, " + arg0 + ", " + local118.toString());
			throw new RuntimeException();
		}
	}
}
