...
public final class Class19 {
	...
	public void method414(@OriginalArg(0) boolean arg0) {
		try {
			...
			signlink.reporterror("47442, " + arg0 + ", " + local56.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIIIZI)V")
	public void method415(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		try {
			if (arg2 >= 9 && arg2 <= 9) {
			...
			signlink.reporterror("48949, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + local468.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZIIIIII)V")
	public void method416(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		try {
			@Pc(3) int local3 = 256;
			if (arg0) {
				local3 += 131072;
			}
			@Pc(14) int local14 = arg6 - this.anInt694;
			if (arg1 == 3) {
				...
				for (local31 = local14; local31 < local14 + arg4; local31++) {
			...
			signlink.reporterror("28834, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + local74.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method417(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			signlink.reporterror("79416, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method419(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		try {
			...
			if (arg1 == 4) {
				if (arg0 == 0) {
					if (arg3 == 0) {
						this.method421(0, local9, 128, local4);
						this.method421(0, local9, 8, local4 - 1);
					}
					if (arg3 == 1) {
						this.method421(0, local9, 2, local4);
						this.method421(0, local9 + 1, 32, local4);
					}
					if (arg3 == 2) {
						this.method421(0, local9, 8, local4);
						this.method421(0, local9, 128, local4 + 1);
					}
					if (arg3 == 3) {
						this.method421(0, local9, 32, local4);
						this.method421(0, local9 - 1, 2, local4);
					}
				}
				if (arg0 == 1 || arg0 == 3) {
					if (arg3 == 0) {
						this.method421(0, local9, 1, local4);
						this.method421(0, local9 + 1, 16, local4 - 1);
					}
					if (arg3 == 1) {
						this.method421(0, local9, 4, local4);
						this.method421(0, local9 + 1, 64, local4 + 1);
					}
					if (arg3 == 2) {
						this.method421(0, local9, 16, local4);
						this.method421(0, local9 - 1, 1, local4 + 1);
					}
					if (arg3 == 3) {
						this.method421(0, local9, 64, local4);
						this.method421(0, local9 - 1, 4, local4 - 1);
					}
				}
				if (arg0 == 2) {
					if (arg3 == 0) {
						this.method421(0, local9, 130, local4);
						this.method421(0, local9, 8, local4 - 1);
						this.method421(0, local9 + 1, 32, local4);
					}
					if (arg3 == 1) {
						this.method421(0, local9, 10, local4);
						this.method421(0, local9 + 1, 32, local4);
						this.method421(0, local9, 128, local4 + 1);
					}
					if (arg3 == 2) {
						this.method421(0, local9, 40, local4);
						this.method421(0, local9, 128, local4 + 1);
						this.method421(0, local9 - 1, 2, local4);
					}
					if (arg3 == 3) {
						this.method421(0, local9, 160, local4);
						this.method421(0, local9 - 1, 2, local4);
						this.method421(0, local9, 8, local4 - 1);
					}
				}
				if (arg5) {
					if (arg0 == 0) {
						if (arg3 == 0) {
							this.method421(0, local9, 65536, local4);
							this.method421(0, local9, 4096, local4 - 1);
						}
						if (arg3 == 1) {
							this.method421(0, local9, 1024, local4);
							this.method421(0, local9 + 1, 16384, local4);
						}
						if (arg3 == 2) {
							this.method421(0, local9, 4096, local4);
							this.method421(0, local9, 65536, local4 + 1);
						}
						if (arg3 == 3) {
							this.method421(0, local9, 16384, local4);
							this.method421(0, local9 - 1, 1024, local4);
						}
					}
					if (arg0 == 1 || arg0 == 3) {
						if (arg3 == 0) {
							this.method421(0, local9, 512, local4);
							this.method421(0, local9 + 1, 8192, local4 - 1);
						}
						if (arg3 == 1) {
							this.method421(0, local9, 2048, local4);
							this.method421(0, local9 + 1, 32768, local4 + 1);
						}
						if (arg3 == 2) {
							this.method421(0, local9, 8192, local4);
							this.method421(0, local9 - 1, 512, local4 + 1);
						}
						if (arg3 == 3) {
							this.method421(0, local9, 32768, local4);
							this.method421(0, local9 - 1, 2048, local4 - 1);
						}
					}
					if (arg0 == 2) {
						if (arg3 == 0) {
							this.method421(0, local9, 66560, local4);
							this.method421(0, local9, 4096, local4 - 1);
							this.method421(0, local9 + 1, 16384, local4);
						}
						if (arg3 == 1) {
							this.method421(0, local9, 5120, local4);
							this.method421(0, local9 + 1, 16384, local4);
							this.method421(0, local9, 65536, local4 + 1);
						}
						if (arg3 == 2) {
							this.method421(0, local9, 20480, local4);
							this.method421(0, local9, 65536, local4 + 1);
							this.method421(0, local9 - 1, 1024, local4);
						}
						if (arg3 == 3) {
							this.method421(0, local9, 81920, local4);
							this.method421(0, local9 - 1, 1024, local4);
							this.method421(0, local9, 4096, local4 - 1);
							return;
						}
	...
	public void method420(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		try {
			@Pc(3) int local3 = 256;
			if (arg0) {
				local3 += 131072;
				...
				if (local38 >= 0 && local38 < this.anInt696) {
					for (@Pc(54) int local54 = local19; local54 < local19 + arg4; local54++) {
						if (local54 >= 0 && local54 < this.anInt697) {
							this.method421(0, local54, local3, local38);
						}
					}
				}
			}
		} catch (@Pc(82) RuntimeException local82) {
			signlink.reporterror("56212, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + local82.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method421(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			this.anIntArrayArray17[arg3][arg1] &= 16777215 - arg2;
			if (arg0 != 0) {
				this.aBoolean174 = !this.aBoolean174;
			}
		} catch (@Pc(23) RuntimeException local23) {
			signlink.reporterror("60943, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local23.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZII)V")
	public void method422(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(4) int local4 = arg2 - this.anInt694;
			@Pc(9) int local9 = arg1 - this.anInt695;
			this.anIntArrayArray17[local4][local9] &= 0xDFFFFF;
			if (!arg0) {
				;
			}
		} catch (@Pc(23) RuntimeException local23) {
			signlink.reporterror("96052, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local23.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIIIIII)Z")
	public boolean method423(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		try {
			if (arg6 == arg2 && arg3 == arg4) {
				return true;
			}
			@Pc(12) int local12 = arg6 - this.anInt694;
			if (arg0 <= 0) {
				this.aBoolean172 = !this.aBoolean172;
			}
			@Pc(27) int local27 = arg3 - this.anInt695;
			@Pc(32) int local32 = arg2 - this.anInt694;
			@Pc(37) int local37 = arg4 - this.anInt695;
			if (arg5 == 0) {
				if (arg1 == 0) {
			...
			signlink.reporterror("89767, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + local570.toString());
			throw new RuntimeException();
		}
	}
	...
	public boolean method425(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		try {
			...
			@Pc(16) int local16 = arg7 + arg5 - 1;
			if (arg1 >= arg3 && arg1 <= local10 && arg4 >= arg7 && arg4 <= local16) {
				return true;
			} else if (arg1 == arg3 - 1 && arg4 >= arg7 && arg4 <= local16 && (this.anIntArrayArray17[arg1 - this.anInt694][arg4 - this.anInt695] & 0x8) == 0 && (arg2 & 0x8) == 0) {
				return true;
			} else if (arg1 == local10 + 1 && arg4 >= arg7 && arg4 <= local16 && (this.anIntArrayArray17[arg1 - this.anInt694][arg4 - this.anInt695] & 0x80) == 0 && (arg2 & 0x2) == 0) {
				return true;
			} else if (arg4 == arg7 - 1 && arg1 >= arg3 && arg1 <= local10 && (this.anIntArrayArray17[arg1 - this.anInt694][arg4 - this.anInt695] & 0x2) == 0 && (arg2 & 0x4) == 0) {
				return true;
			} else {
			...
			signlink.reporterror("95587, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + local161.toString());
			throw new RuntimeException();
		}
	}
}
