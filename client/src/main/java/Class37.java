...
public final class Class37 implements ImageProducer, ImageObserver {
	...
	public void method538(@OriginalArg(0) byte arg0) {
		try {
			if (arg0 == 9) {
				...
				Static14.method453(-216, this.anInt874, this.anIntArray233, this.anInt873);
			}
	...
	public void method539(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Graphics arg2, @OriginalArg(3) boolean arg3) {
		try {
			this.method540();
			...
			signlink.reporterror("93304, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
